...
export default class TasksBoardPresenter {
  ...
  #updateClearButtonStatus(tasksStatus) {
    const isDisabled = tasksStatus.length === 0;
    if (this.#clearButtonComponent) {
        this.#clearButtonComponent.setDisabled(isDisabled);
    }
  };
